export const assets = [
    ...
    {url: "./StartScene/SETTINGS.png", name:"SET1"},
    {url: "./StartScene/SETTINGS2.png", name:"SET2"},
    {url: "./StartScene/SETTINGS3.png", name:"SET3"},
    {url: "./StartScene/BACK.png", name:"BACK1"},
    ...
    {url: "./uipack-rpg/PNG/buttonLong_brown_pressed.png", name:"Marco"},
